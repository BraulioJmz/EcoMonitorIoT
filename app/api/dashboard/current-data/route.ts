...
export async function GET(request: NextRequest) {
  try {
    ...
    if (selectedMachineIds.length > 0) {
      ...
      // Sin máquinas seleccionadas — sumar corrientes de br01 + br02 + br03
      ...
      const rows = await prisma.line_current_matrix.findMany({
        ...
        select: {
          br01_current_l1: true, br01_current_l2: true, br01_current_l3: true,
          br02_current_l1: true, br02_current_l2: true, br02_current_l3: true,
          br03_current_l1: true, br03_current_l2: true, br03_current_l3: true,
          timestamp: true
        }
      })
